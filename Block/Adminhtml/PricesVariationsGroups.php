 ...
 */
class Pricesvariationsgroups extends \Magento\Backend\Block\Widget\Grid\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_headerText = __('Prices Variations Groups');

        parent::_construct();

        $location = $this->getUrl('*/pricesvariation');
        $this->buttonList->add(
            'variations',
            [
